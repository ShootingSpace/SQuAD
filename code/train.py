...
tf.app.flags.DEFINE_float("keep_prob", 1.0, "The probably that a node is kept after the affine transform")
...
def main(_):
    ...
    elif FLAGS.which_model in ["Attention-BiAFCOM"]:
        qa = Attention_BiAFCOM.QASystem(embeddings, FLAGS)
